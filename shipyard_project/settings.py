"""
Django settings for shipyard_project project.
...
SECRET_KEY = 'django-insecure-poq&oz_!%b!h4b#*!$=7mivun4kyjw3t@7bhug5p+qu##b1nll'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Ensure you have this for development
